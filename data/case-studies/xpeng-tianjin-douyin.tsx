    ...
    <>
      <CaseStudySection id="why" num="一、" title="任务背景（Why）">
        ...
        <Paragraph>
          ...
          总部希望各门店探索社交媒体获客打法，我所在的华北二区把这件事交给天津空港店试点——由我从 0 跑出一套可复用的方法。
        </Paragraph>
      ...
      <CaseStudySection id="what" num="二、" title="三大支柱（What）">
        ...
        <Paragraph>
          天津空港店账号定位为<strong>「天津小鹏车主真实生活」</strong>——不是品牌官号、不是销售号，而是一个把车主日常拍出来的本地账号。这个定位让算法在「天津 + 新能源车 + 25-40 岁」标签下精准推送，避免无效曝光。
        </Paragraph>
      ...
      <CaseStudySection id="how" num="三、" title="2 月增长执行（How）">
        ...
        <Callout variant="decision">
          <strong>关键决策：</strong>第 3 周时总部建议加入更多「新车配置介绍」类官方内容，但我用 Week 1-2 的实测数据说服总部——
          在我们这个账号上，这类内容的互动率明显低于「真实车主故事」。坚持本地化定位才是它的护城河。
        </Callout>
      </CaseStudySection>
      ...
      <CaseStudySection id="reflection" num="五、" title="反思与转型 AI PM">
        ...
        <Callout variant="insight">
          ...
          <br /><br />
          2. 在数字化原生的产品里，<strong>懂一点技术的 PM 在塑造产品形态上有显著优势</strong>。这是我去 UQ 读交互设计硕士、并最终聚焦 AI PM 的根本原因。
        </Callout>
